...
import 'package:calender/eventcalender.dart';
import 'package:calender/simple.dart';
...
class MyTestPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: Text("Calender",style: TextStyle(
          backgroundColor: Colors.amber
        ),),
        backgroundColor: Colors.amber),
        body: EventCalendarScreen(),
      ),
    );
  }
}
...
// import 'package:calender/infinite_list_page.dart';
